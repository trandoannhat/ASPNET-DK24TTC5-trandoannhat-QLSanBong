...
using QLSanBong.Common.Exceptions; // Để ném lỗi nếu upload thất bại
using System;
using System.IO;
using System.Net;
    ...
    public class CloudinaryFileService : IFileService
    {
        ...
        public async Task<string> UploadImageAsync(IFormFile file, string folder)
        {
            ...
            var uploadParams = new ImageUploadParams
            {
                ...
                // Cấu trúc folder trên Cloud: QLSanBong/projects hoặc QLSanBong/avatars
                Folder = $"QLSanBong/{folder}",
