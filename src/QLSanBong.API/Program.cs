...
using QLSanBong.API.Middlewares;
using QLSanBong.Application; // Gọi DI của Application
using QLSanBong.Application.Settings;
using QLSanBong.Common.Wrappers;
using QLSanBong.Infrastructure; // Gọi DI của Infrastructure
using System.Text;
...
// B. GỌI CÁC TẦNG KIẾN TRÚC VÀO ĐÂY 
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "QLSanBong API Core",
        Version = "v1",
            Description = "Hệ thống Backend quản lý Đặt Sân Bóng",
        Contact = new Microsoft.OpenApi.Models.OpenApiContact { Name = "QLSanBong", Email = "contact@QLSanBong.com" }
    });
...
using (var scope = app.Services.CreateScope())
{
    ...
    {
        // Chạy hàm tạo Admin
        await QLSanBong.API.Extensions.DataSeeder.SeedAdminUserAsync(services);
    }
    catch (Exception ex)
    {
...
app.UseAuthentication(); // Phải có Authenticate & Authorize sau UseCors
